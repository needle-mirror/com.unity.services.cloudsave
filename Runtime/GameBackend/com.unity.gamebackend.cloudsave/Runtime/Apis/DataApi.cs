...
namespace Unity.GameBackend.CloudSave.Apis.Data
{
    /// <summary>
    ...
    internal interface IDataApiClient
    {
            ...
            /// <exception cref="Unity.GameBackend.CloudSave.Http.HttpException">An exception containing the HttpClientResponse with headers, response code, and string of error.</exception>

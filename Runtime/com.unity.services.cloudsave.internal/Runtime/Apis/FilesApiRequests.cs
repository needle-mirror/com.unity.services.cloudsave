...
namespace Unity.Services.CloudSave.Internal.Files
{
    ...
    internal class DeleteFileRequest : FilesApiBaseRequest
    {
        ...
        /// Delete a Player File
        /// </summary>
        /// <param name="key">The key of the player stored contents. It should only contain alphanumeric characters, underscores or dashes, and it should not start with a period. A file extension is optional.</param>
        ...
        [Preserve]
        public DeleteFileRequest(string key, string projectId, string playerId, string writeLock = default(string))
        {
            Key = key;
            ...
            WriteLock = writeLock;
            PathAndQueryParams = $"/v1/files/projects/{projectId}/players/{playerId}/items/{key}";
    ...
    /// </summary>
    [Preserve]
    internal class GetDownloadUrlRequest : FilesApiBaseRequest
    {
        /// <summary>Accessor for key </summary>
        [Preserve]
        public string Key { get; }
        ...
        /// <param name="playerId">playerId param</param>
        [Preserve]
        public GetDownloadUrlRequest(string key, string projectId, string playerId)
        {
            Key = key;
    ...
    /// </summary>
    [Preserve]
    internal class GetFileMetadataRequest : FilesApiBaseRequest
    {
        /// <summary>Accessor for projectId </summary>
        [Preserve]
        public string ProjectId { get; }
        ...
        /// <summary>
        /// GetFileMetadata Request Object.
        /// Get the metadata of a file
        /// </summary>
        /// <param name="projectId">projectId param</param>
        /// <param name="playerId">playerId param</param>
        /// <param name="key">The key of the player stored contents. It should only contain alphanumeric characters, underscores or dashes, and it should not start with a period. A file extension is optional.</param>
        [Preserve]
        public GetFileMetadataRequest(string projectId, string playerId, string key)
        {
            ProjectId = projectId;
            ...
            PathAndQueryParams = $"/v1/files/projects/{projectId}/players/{playerId}/items/{key}/metadata";
    ...
    /// </summary>
    [Preserve]
    internal class GetUploadUrlRequest : FilesApiBaseRequest
    {
        /// <summary>Accessor for key </summary>
        [Preserve]
        public string Key { get; }
        ...
        [Preserve]
        public GetUploadUrlRequest(string key, string projectId, string playerId, Unity.Services.CloudSave.Internal.Models.FileDetails fileDetails = default(Unity.Services.CloudSave.Internal.Models.FileDetails))
        {
            Key = key;
    ...
    internal class ListFilesRequest : FilesApiBaseRequest
    {
        ...
        /// <param name="projectId">projectId param</param>
        /// <param name="playerId">playerId param</param>
        /// <param name="after">The key after which to retrieve the list of files</param>
        [Preserve]

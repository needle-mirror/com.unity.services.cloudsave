...
{
    /// <summary>
    /// DeleteItems400OneOf model
    /// </summary>
    [Preserve]
    [JsonConverter(typeof(DeleteItems400OneOfJsonConverter))]
    [DataContract(Name = "DeleteItems400OneOf")]
    internal class DeleteItems400OneOf : IOneOf
    {
        ...
        /// <summary>DeleteItems400OneOf Constructor</summary>
        /// <param name="value">The value as an object for DeleteItems400OneOf</param>
        /// <param name="type">The type for DeleteItems400OneOf</param>
        public DeleteItems400OneOf(object value, Type type)
        {
            this.Value = value;
            this.Type = type;
        }
        ...
        /// <summary>
        /// Converts the JSON string into an instance of DeleteItems400OneOf
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of DeleteItems400OneOf</returns>
        public static DeleteItems400OneOf FromJson(string jsonString)
        {
            if (jsonString == null)
            {
                return null;
            ...
            else
            {
                ...
                {
                    throw new MissingFieldException("DeleteItems400OneOf", DiscriminatorKey);
                }
        ...
        private static DeleteItems400OneOf DeserializeIntoActualObject(string discriminatorValue, string jsonString)
        {
            ...
            return new DeleteItems400OneOf(actualObject, concreteType);
        }

        private static DeleteItems400OneOf DeserializeIntoActualObject(string jsonString)
        {
            ...
            return new DeleteItems400OneOf(results.First().ActualObject, results.First().ActualType);
        }
    }

    /// <summary>
    /// Custom JSON converter for DeleteItems400OneOf to allow for deserialization into OneOf type
    /// </summary>
    [Preserve]
    internal class DeleteItems400OneOfJsonConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return DeleteItems400OneOf.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }

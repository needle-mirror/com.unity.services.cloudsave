...
{
    /// <summary>
    /// ListFiles400OneOf model
    /// </summary>
    [Preserve]
    [JsonConverter(typeof(ListFiles400OneOfJsonConverter))]
    [DataContract(Name = "ListFiles400OneOf")]
    internal class ListFiles400OneOf : IOneOf
    {
        ...
        /// <summary>ListFiles400OneOf Constructor</summary>
        /// <param name="value">The value as an object for ListFiles400OneOf</param>
        /// <param name="type">The type for ListFiles400OneOf</param>
        public ListFiles400OneOf(object value, Type type)
        {
            this.Value = value;
            this.Type = type;
        }
        ...
        /// <summary>
        /// Converts the JSON string into an instance of ListFiles400OneOf
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of ListFiles400OneOf</returns>
        public static ListFiles400OneOf FromJson(string jsonString)
        {
            if (jsonString == null)
            {
                return null;
            ...
            else
            {
                ...
                {
                    throw new MissingFieldException("ListFiles400OneOf", DiscriminatorKey);
                }
        ...
        private static ListFiles400OneOf DeserializeIntoActualObject(string discriminatorValue, string jsonString)
        {
            ...
            return new ListFiles400OneOf(actualObject, concreteType);
        }

        private static ListFiles400OneOf DeserializeIntoActualObject(string jsonString)
        {
            ...
            return new ListFiles400OneOf(results.First().ActualObject, results.First().ActualType);
        }
    }

    /// <summary>
    /// Custom JSON converter for ListFiles400OneOf to allow for deserialization into OneOf type
    /// </summary>
    [Preserve]
    internal class ListFiles400OneOfJsonConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return ListFiles400OneOf.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }

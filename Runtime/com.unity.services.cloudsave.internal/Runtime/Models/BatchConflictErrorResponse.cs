...
namespace Unity.Services.CloudSave.Internal.Models
{
    ...
    internal class BatchConflictErrorResponse
    {
        ...
        [Preserve]
        public BatchConflictErrorResponse(string type, string title, int status, int code, string detail, List<ConflictErrorResponseData> data, string instance = default)
        {
            Type = type;
            Title = title;
            Status = status;
        ...
        public List<ConflictErrorResponseData> Data{ get; }
    
        /// <summary>
        /// Formats a BatchConflictErrorResponse into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a BatchConflictErrorResponse as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>

...
{
    /// <summary>
    /// GetFileMetadata400OneOf model
    /// </summary>
    [Preserve]
    [JsonConverter(typeof(GetFileMetadata400OneOfJsonConverter))]
    [DataContract(Name = "GetFileMetadata400OneOf")]
    internal class GetFileMetadata400OneOf : IOneOf
    {
        ...
        /// <summary>GetFileMetadata400OneOf Constructor</summary>
        /// <param name="value">The value as an object for GetFileMetadata400OneOf</param>
        /// <param name="type">The type for GetFileMetadata400OneOf</param>
        public GetFileMetadata400OneOf(object value, Type type)
        {
            this.Value = value;
            this.Type = type;
        }
        ...
        /// <summary>
        /// Converts the JSON string into an instance of GetFileMetadata400OneOf
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of GetFileMetadata400OneOf</returns>
        public static GetFileMetadata400OneOf FromJson(string jsonString)
        {
            if (jsonString == null)
            {
                return null;
            ...
            else
            {
                ...
                {
                    throw new MissingFieldException("GetFileMetadata400OneOf", DiscriminatorKey);
                }
        ...
        private static GetFileMetadata400OneOf DeserializeIntoActualObject(string discriminatorValue, string jsonString)
        {
            ...
            return new GetFileMetadata400OneOf(actualObject, concreteType);
        }

        private static GetFileMetadata400OneOf DeserializeIntoActualObject(string jsonString)
        {
            ...
            return new GetFileMetadata400OneOf(results.First().ActualObject, results.First().ActualType);
        }
    }

    /// <summary>
    /// Custom JSON converter for GetFileMetadata400OneOf to allow for deserialization into OneOf type
    /// </summary>
    [Preserve]
    internal class GetFileMetadata400OneOfJsonConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return GetFileMetadata400OneOf.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }

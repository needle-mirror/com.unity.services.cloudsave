...
{
    /// <summary>
    /// GetDownloadUrl400OneOf model
    /// </summary>
    [Preserve]
    [JsonConverter(typeof(GetDownloadUrl400OneOfJsonConverter))]
    [DataContract(Name = "GetDownloadUrl400OneOf")]
    internal class GetDownloadUrl400OneOf : IOneOf
    {
        ...
        /// <summary>GetDownloadUrl400OneOf Constructor</summary>
        /// <param name="value">The value as an object for GetDownloadUrl400OneOf</param>
        /// <param name="type">The type for GetDownloadUrl400OneOf</param>
        public GetDownloadUrl400OneOf(object value, Type type)
        {
            this.Value = value;
            this.Type = type;
        }
        ...
        /// <summary>
        /// Converts the JSON string into an instance of GetDownloadUrl400OneOf
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of GetDownloadUrl400OneOf</returns>
        public static GetDownloadUrl400OneOf FromJson(string jsonString)
        {
            if (jsonString == null)
            {
                return null;
            ...
            else
            {
                ...
                {
                    throw new MissingFieldException("GetDownloadUrl400OneOf", DiscriminatorKey);
                }
        ...
        private static GetDownloadUrl400OneOf DeserializeIntoActualObject(string discriminatorValue, string jsonString)
        {
            ...
            return new GetDownloadUrl400OneOf(actualObject, concreteType);
        }

        private static GetDownloadUrl400OneOf DeserializeIntoActualObject(string jsonString)
        {
            ...
            return new GetDownloadUrl400OneOf(results.First().ActualObject, results.First().ActualType);
        }
    }

    /// <summary>
    /// Custom JSON converter for GetDownloadUrl400OneOf to allow for deserialization into OneOf type
    /// </summary>
    [Preserve]
    internal class GetDownloadUrl400OneOfJsonConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return GetDownloadUrl400OneOf.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }

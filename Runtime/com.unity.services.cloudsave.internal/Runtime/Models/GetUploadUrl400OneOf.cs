...
{
    /// <summary>
    /// GetUploadUrl400OneOf model
    /// </summary>
    [Preserve]
    [JsonConverter(typeof(GetUploadUrl400OneOfJsonConverter))]
    [DataContract(Name = "GetUploadUrl400OneOf")]
    internal class GetUploadUrl400OneOf : IOneOf
    {
        ...
        /// <summary>GetUploadUrl400OneOf Constructor</summary>
        /// <param name="value">The value as an object for GetUploadUrl400OneOf</param>
        /// <param name="type">The type for GetUploadUrl400OneOf</param>
        public GetUploadUrl400OneOf(object value, Type type)
        {
            this.Value = value;
            this.Type = type;
        }
        ...
        /// <summary>
        /// Converts the JSON string into an instance of GetUploadUrl400OneOf
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of GetUploadUrl400OneOf</returns>
        public static GetUploadUrl400OneOf FromJson(string jsonString)
        {
            if (jsonString == null)
            {
                return null;
            ...
            else
            {
                ...
                {
                    throw new MissingFieldException("GetUploadUrl400OneOf", DiscriminatorKey);
                }
        ...
        private static GetUploadUrl400OneOf DeserializeIntoActualObject(string discriminatorValue, string jsonString)
        {
            ...
            return new GetUploadUrl400OneOf(actualObject, concreteType);
        }

        private static GetUploadUrl400OneOf DeserializeIntoActualObject(string jsonString)
        {
            ...
            return new GetUploadUrl400OneOf(results.First().ActualObject, results.First().ActualType);
        }
    }

    /// <summary>
    /// Custom JSON converter for GetUploadUrl400OneOf to allow for deserialization into OneOf type
    /// </summary>
    [Preserve]
    internal class GetUploadUrl400OneOfJsonConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return GetUploadUrl400OneOf.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }

...
{
    /// <summary>
    /// BadRequestOneOfErrorResponse model
    /// </summary>
    [Preserve]
    [JsonConverter(typeof(BadRequestOneOfErrorResponseJsonConverter))]
    [DataContract(Name = "BadRequestOneOfErrorResponse")]
    internal class BadRequestOneOfErrorResponse : IOneOf
    {
        ...
        /// <summary>BadRequestOneOfErrorResponse Constructor</summary>
        /// <param name="value">The value as an object for BadRequestOneOfErrorResponse</param>
        /// <param name="type">The type for BadRequestOneOfErrorResponse</param>
        public BadRequestOneOfErrorResponse(object value, Type type)
        {
            this.Value = value;
            this.Type = type;
        }
        ...
        /// <summary>
        /// Converts the JSON string into an instance of BadRequestOneOfErrorResponse
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of BadRequestOneOfErrorResponse</returns>
        public static BadRequestOneOfErrorResponse FromJson(string jsonString)
        {
            if (jsonString == null)
            {
                return null;
            ...
            else
            {
                ...
                {
                    throw new MissingFieldException("BadRequestOneOfErrorResponse", DiscriminatorKey);
                }
        ...
        private static BadRequestOneOfErrorResponse DeserializeIntoActualObject(string discriminatorValue, string jsonString)
        {
            ...
            return new BadRequestOneOfErrorResponse(actualObject, concreteType);
        }

        private static BadRequestOneOfErrorResponse DeserializeIntoActualObject(string jsonString)
        {
            ...
            return new BadRequestOneOfErrorResponse(results.First().ActualObject, results.First().ActualType);
        }
    }

    /// <summary>
    /// Custom JSON converter for BadRequestOneOfErrorResponse to allow for deserialization into OneOf type
    /// </summary>
    [Preserve]
    internal class BadRequestOneOfErrorResponseJsonConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return BadRequestOneOfErrorResponse.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }

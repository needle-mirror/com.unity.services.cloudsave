...
namespace Unity.Services.CloudSave.Internal.Apis.Data
{
    ...
    internal interface IDataApiClient
    {
            ...
            /// <exception cref="Unity.Services.CloudSave.Internal.Http.HttpException">An exception containing the HttpClientResponse with headers, response code, and string of error.</exception>
            Task<Response<GetItemsResponse>> GetItemsAsync(Unity.Services.CloudSave.Internal.Data.GetItemsRequest request, Configuration operationConfiguration = null);
            ...
            /// <exception cref="Unity.Services.CloudSave.Internal.Http.HttpException">An exception containing the HttpClientResponse with headers, response code, and string of error.</exception>
            Task<Response<GetKeysResponse>> GetKeysAsync(Unity.Services.CloudSave.Internal.Data.GetKeysRequest request, Configuration operationConfiguration = null);
            ...
            /// <exception cref="Unity.Services.CloudSave.Internal.Http.HttpException">An exception containing the HttpClientResponse with headers, response code, and string of error.</exception>
            Task<Response<SetItemResponse>> SetItemAsync(Unity.Services.CloudSave.Internal.Data.SetItemRequest request, Configuration operationConfiguration = null);
            ...
            /// <exception cref="Unity.Services.CloudSave.Internal.Http.HttpException">An exception containing the HttpClientResponse with headers, response code, and string of error.</exception>
            Task<Response<SetItemBatchResponse>> SetItemBatchAsync(Unity.Services.CloudSave.Internal.Data.SetItemBatchRequest request, Configuration operationConfiguration = null);
    ...
    internal class DataApiClient : BaseApiClient, IDataApiClient
    {
        ...
        /// <returns>Task for a Response object containing status code, headers, and GetItemsResponse object.</returns>
        /// <exception cref="Unity.Services.CloudSave.Internal.Http.HttpException">An exception containing the HttpClientResponse with headers, response code, and string of error.</exception>
        public async Task<Response<GetItemsResponse>> GetItemsAsync(Unity.Services.CloudSave.Internal.Data.GetItemsRequest request,
            Configuration operationConfiguration = null)
        {
        ...
        /// <returns>Task for a Response object containing status code, headers, and GetKeysResponse object.</returns>
        /// <exception cref="Unity.Services.CloudSave.Internal.Http.HttpException">An exception containing the HttpClientResponse with headers, response code, and string of error.</exception>
        public async Task<Response<GetKeysResponse>> GetKeysAsync(Unity.Services.CloudSave.Internal.Data.GetKeysRequest request,
            Configuration operationConfiguration = null)
        {
        ...
        /// <returns>Task for a Response object containing status code, headers, and SetItemResponse object.</returns>
        /// <exception cref="Unity.Services.CloudSave.Internal.Http.HttpException">An exception containing the HttpClientResponse with headers, response code, and string of error.</exception>
        public async Task<Response<SetItemResponse>> SetItemAsync(Unity.Services.CloudSave.Internal.Data.SetItemRequest request,
            Configuration operationConfiguration = null)
        {
        ...
        /// <returns>Task for a Response object containing status code, headers, and SetItemBatchResponse object.</returns>
        /// <exception cref="Unity.Services.CloudSave.Internal.Http.HttpException">An exception containing the HttpClientResponse with headers, response code, and string of error.</exception>
        public async Task<Response<SetItemBatchResponse>> SetItemBatchAsync(Unity.Services.CloudSave.Internal.Data.SetItemBatchRequest request,
            Configuration operationConfiguration = null)
        {
